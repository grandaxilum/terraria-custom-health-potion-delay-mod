...
- Works with vanilla and any modded health potions (mod-agnostic, e.g. Calamity)
...
- In-game, you can adjust the multiplier under **Settings > Mod Configs > Custom Health Potion Delay Config** if needed
